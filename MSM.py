...
ds['relative_humidity'] = xr.where(mask, ds['relative_humidity'] * (10 ** (7.5 * temp / (237.3 + temp) - 9.5 * temp /(265.5 + temp))))
...
## 時系列図作成
# ポイント指定
i_lat, i_lon= 119, 158  # 羽田 35.5554N　139.754E
...
fig.text(0.5,0.01,"{:.2f}N, {:.2f}E MSM FT{:03d}-{:03d} {}Z Initial".format(lats[i_lat],lons[i_lon],fts[0],fts[-1],dt), ha='center',va='bottom', size=15)
plt.savefig('msm.png')

...
# 8時間引く
adjusted_time = now_utc - datetime.timedelta(hours=6)
...
gsm_fn_t="Z__C_RJTD_{0:4d}{1:02d}{2:02d}{3:02d}0000_GSM_GPV_Rjp_Gll0p1deg_L-pall_FD{4:s}_grib2.bin"
...
## 時系列図作成
# ポイント指定
i_lat, i_lon= 143, 158  # 羽田 35.5554N　139.754E
